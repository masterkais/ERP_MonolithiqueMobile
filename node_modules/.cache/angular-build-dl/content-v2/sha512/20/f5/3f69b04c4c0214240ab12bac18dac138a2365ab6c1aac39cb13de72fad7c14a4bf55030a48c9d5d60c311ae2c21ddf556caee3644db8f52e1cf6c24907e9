...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
  ...
  function srcAppPagesLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_rest_authentification_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/services/rest/authentification.service */
    "./src/app/services/rest/authentification.service.ts");

    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(menuCtrl, navCtrl, util, router, api, authService, loadingCtrl) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 7:
                    ...
                    loading.present();
                    this.authService.login(dataForm).subscribe(function (resp) {
                      var jwt = resp.headers.get("Authorization");

                      _this2.authService.saveToken(jwt);

                      console.log("success");
                      setTimeout(function () {
                        _this2.router.navigateByUrl('/charts');
                      ...
                      _this2.util.showToast('Veuillez vérifier vos données !', 'danger', 'bottom');
                    });
