...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-rest-rest-details-rest-details-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesRestRestDetailsRestDetailsPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesRestRestDetailsRestDetailsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesRestRestDetailsRestDetailsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesRestRestDetailsRestDetailsPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesRestRestDetailsRestDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    */
    ...
    var RestDetailsPage = /*#__PURE__*/function () {
      function RestDetailsPage(route, util, navCtrl, api) {
      ...
      _createClass(RestDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.queryParams.subscribe(function (data) {
            ...
            if (data.hasOwnProperty('data')) {
              ...
              _this.id = info.id, _this.title = info.title;
        ...
        value: function update() {
          ...
          this.api.post(param, 'Basics/editList').then(function (data) {
            var info = JSON.parse(data.data);
            console.log(info);
...
//# sourceMappingURL=pages-rest-rest-details-rest-details-module-es5.js.map